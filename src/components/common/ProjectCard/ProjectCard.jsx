        ...
        return (
            <div className="project-card-horizontal">
                ...
                <div className="horiz-content">
                    ...
                    <a href={project.href} className="read-more-link">Read More</a>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="project-card-item wow fadeInUp">
            <div className="project-img-wrapper">
                <img src={project.image} alt={project.title} />
                <div className={`project-status-badge status-${project.status?.toLowerCase().replace(/\s+/g, '-')}`}>
                    {project.status}
                </div>
            </div>
            <div className="project-content-body">
                ...
                <div className="project-card-button-section">
                    <ThemeBtn href={`/project-details/${project.id}`} className="view-details-btn">
                        View Details
                    </ThemeBtn>
                    <ThemeBtn href={`/project-details/${project.id}`} className="view-details-btn">
                        Enquireies
