...
const RegistrationContent = () => {
  ...
  const defaultValues = useMemo(
    () => ({
      agentType: agentTypeParam || INDIVIDUAL_AGENT_TYPE,
      gstin: "",
      fullname: "",
      agency_name: "",
      phone: "",
  ...
  useEffect(() => {
    if (agentTypeParam) {
      setValue("agentType", agentTypeParam, { shouldDirty: false });
    }
  }, [agentTypeParam, setValue]);
                ...
                >
                  ...
                  <div className="tab-text">
                    ...
                    <span className="tab-title">
                      {isIndividual ? "Refer" : "Address"}
                    </span>
                    <span className="tab-sub">
                      {isIndividual ? "Add Refer" : "Add Address"}
                    </span>
                  </div>
                </div>
              </div>
