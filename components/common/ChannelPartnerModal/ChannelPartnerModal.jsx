...
const ChannelPartnerModal = ({ isOpen, onClose }) => {
  ...
  const handleRegistration = (type) => {
    onClose();
    router.push(
      `/registration?agentType=${encodeURIComponent(type)}`,
    );
  };
          ...
          >
            ...
            <div className="cp-modal-left-inner">
              ...
              <p className="cp-modal-description">
                Are you an ambitious broker seeking new growth? Join Blanca
                Developers and work with one of the region&apos;s most trusted
                developers. Enjoy a dynamic environment, solid support, and
                real opportunities to succeed.
              </p>
              <p className="cp-modal-description">
                Our expert team equips you with the training and support to
                succeed in a competitive market. Grow your career with Blanca
                Developers and reach new heights.
              </p>
            </div>
          </div>
            ...
            <div className="cp-modal-right-inner">
              ...
              <div className="cp-modal-actions">
                ...
                <ThemeBtn
                  ...
                  style={{ justifyContent: "center" }}
                  onClick={() =>
                    handleRegistration("Individual Registration")
                  }
                >
