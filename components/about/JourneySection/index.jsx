  ...
  const journeyData = React.useMemo(() => {
    ...
    return list
      .flatMap((group) => {
        ...
        const projectsRaw =
          group?.projects ?? group?.data ?? group?.items ?? [];
      ...
      .filter(
        (g) => Boolean(g) && Array.isArray(g.projects) && g.projects.length > 0,
      );
  }, [journeyResponse]);
        ...
        >
          ...
          {item?.projects?.map((project, pIndex) => {
            const dynamicPosition =
              (currentOffset + pIndex) % 2 === 0 ? "above" : "below";
            const imgSrc =
            ...
            const cardInner = (
              <>
                {imgSrc && (
                  <div style={{ position: "relative", width: "100%", maxHeight: "300px" }}>
                    <img
                      ...
                      style={{ objectFit: "cover", width: "100%", height: "300px", display: "block" }}
                ...
                <div className="project-meta">
                  <Icon icon="lucide:map-pin" className="journey-meta-icon" />{" "}
                  {project.location}
                  <Icon
                    icon={
          ...
          <div
            ...
            style={item.yearWidth ? { width: item.yearWidth } : {}}
          >
